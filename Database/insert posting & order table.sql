...
insert into orders (requestOrderUser_id, postOrderUser_id, posting_id, description, dateRequested, dateResponsed, dateCompleted, status) values
(1, 2, 1, '2 posters for Academic events', '2018-12-02 00:00:00', null, null, 'pending'), 
(2, 1, 2, 'A yearbook for my class','2018-11-29 00:00:00', '2018-11-30 00:00:00', null, 'approved');