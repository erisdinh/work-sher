...
INSERT INTO reviews (review_id, for_user_id, from_user_id, posting_id, review_date, review_rating, review_text) VALUES
	...
	(5, 1, 5, 5, "2018-12-08 00:00:00", 1.5, "I did not feel secured but then again, I'm bigger than her" ),
	(6, 7, 5, 3, "2018-12-08 00:00:00", 1.0, "Bear claws scratch. :(" ),
	(7, 9, 5, 6, "2018-12-08 00:00:00", 5.0, "This elephant is all i want and more" ),
...
INSERT INTO orders (order_id, requestOrderUser_id, postOrderUser_id, posting_id, description, dateRequested, dateResponsed, dateCompleted, status) VALUES
	...
	(6, 8, 9, 9, "Nude, clothed, drapery studies. I have a lot of props!", cast("2018-12-06 00:00:00" as datetime), cast("2018-12-09 00:00:00" as datetime), cast("2018-12-12 00:00:00" as datetime), "Completed"),
	(7, 7, 9, 9, "Nude, clothed, drapery studies. I have a lot of props!", cast("2018-12-06 00:00:00" as datetime), cast("2018-12-09 00:00:00" as datetime), cast("2018-12-12 00:00:00" as datetime), "Pending"),
